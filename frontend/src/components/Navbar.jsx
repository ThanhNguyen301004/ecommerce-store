...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emarald-800">
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {isAdmin && (
              <Link className="bg-emerald-700 hover:bg-emerald-600 text-white px-4 py-2 rounded-md font-medium traisition duration-300 ease-in-out flex items-center"
              to={"/secret-dashboard"}>
            ...
            {user ? (
              ...
              <>
                <Link to="/signup" className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-md flex items-center transition duration-300 ease-in-out">
                  ...
                  <span className="mr-2" size={18}>Sign Up</span>
                </Link>
                <Link to="/login" className="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out">
                  <LogIn size={18} />
                  <span className="mr-2" size={18}>Login</span>
                </Link>
              </>
            )}
          </nav>
